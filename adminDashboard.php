...
?>
  <div class="col-sm-10 mt-5">
      ...
      <div class="col-sm-4 mt-5">
        <div class="card text-white bg-primary mb-4" style="max-width: 18rem;">
          ...
          <div class="card-body">
            ...
            <a class="btn text-white" href="courses.php">Click here to View</a>
          </div>
        </div>
      </div>
      <div class="col-sm-4 mt-5">
        <div class="card text-white bg-warning mb-4" style="max-width: 18rem;">
          ...
          <div class="card-body">
            ...
            <a class="btn text-white" href="students.php">Click here to View</a>
          </div>
        </div>
      </div>
      <div class="col-sm-4 mt-5">
        <div class="card text-white bg-success mb-4" style="max-width: 18rem;">
          ...
          <div class="card-body">
            ...
            <a class="btn text-white" href="sellreport.php">Click here to View</a>
          </div>
        </div>
      </div>
    </div>
    <div class="mx-5 mt-5 text-center">
      <!--Table-->
      <p class=" bg-info text-white p-3">Ordered Courses</p>
      <?php
      $sql = "SELECT * FROM courseorder";
      $result = $conn->query($sql);
